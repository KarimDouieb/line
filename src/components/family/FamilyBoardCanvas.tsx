...
export type CanvasLayout = Exclude<FamilyLayout, "scene"> | "shelf";

const RENDERERS: Record<CanvasLayout, LayoutRenderer> = {
 ...
 * for every layout except the 3D still life (see SceneThree). Vessel set
 * and adaptation mode come from the shared store so the draw-page peek and
 * the family page stay in sync automatically.
 */
export function FamilyBoardCanvas({ layout, className }: FamilyBoardCanvasProps) {
